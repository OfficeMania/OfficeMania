...
export const pinkButton = $<HTMLButtonElement>("button-whiteboard-red");
export const orangeButton = $<HTMLButtonElement>("button-whiteboard-red");
export const yellowButton = $<HTMLButtonElement>("button-whiteboard-red");
